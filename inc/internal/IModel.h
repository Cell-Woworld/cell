...
public:
	...
	virtual void Read(const DynaArray& name, DynaArray& type, DynaArray& value) = 0;
	...
	virtual bool Persist(const DynaArray& path, const DynaArray& id) = 0;
	virtual bool RestorePersistence(const DynaArray& path, const DynaArray& id) = 0;
